...
echo
echo ${GREEN}:::::::::::::::::::::::::::::::::::::::::::::::::: Running Step 1363, Please wait... ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::${reset}
echo
#----------------------------------------- functions --------------------------------------------
YesNoFunction () {
 # echo $1
...
for i in {1..3}
 do
   ...
   grep -m$i "Singles Total Counts" $S2_3_1Sino | tail -n1 | sed 's|\(.*\)Module.*|\1|' | sed 's/^.*\(Singles*\)/\1/g'
   
   num1=$(grep -m$i 'Singles Total Counts' $S2_1Sino |tail -n1 | sed 's|\(.*\)Module.*|\1|' | sed 's|\(.*\)   Singles Total Counts:*|\1|')
   num2=$(grep -m$i 'Singles Total Counts' $S2_3_1Sino |tail -n1 | sed 's|\(.*\)Module.*|\1|' | sed 's|\(.*\)   Singles Total Counts:*|\1|')
...
chmod +x /usr/g/ctuser/EQ_Automation/Acq_4D_ListMode_Workflow_DOC1758729/TC_2_3_1/Acq4D.1364/Acq4D_1364.sh
"/usr/g/ctuser/EQ_Automation/Acq_4D_ListMode_Workflow_DOC1758729/TC_2_3_1/Acq4D.1364/Acq4D_1364.sh"
