...
echo
sleep 1
echo ${GREEN}:::::::::::::::::::::::::::::::::::::::::::::::::: Running Step 1422, Please wait... ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::${reset}
echo
#----------------------------------------- functions --------------------------------------------
YesNoFunction () {
 # echo $1
...
for i in {1..3}
 do
   ...
   num2=$(grep -m$i "Block Busy Average Deadtime" $S2_3_2Sino | tail -n1 |sed -n -e 's/^.*   Block Busy Average Deadtime: //p')
   echo $num2
